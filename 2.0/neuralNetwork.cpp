...
{				
	//create neuron lists
	//--------------------------------------------------------------------------------------------------------
	for ( int i=0; i < nInput; i++ ) inputNeurons.push_back(0);

	//create input bias neuron
	inputNeurons.push_back(-1);

	for ( int i=0; i < nHidden; i++ ) hiddenNeurons.push_back(0);

	//create hidden bias neuron
	hiddenNeurons.push_back(-1);

	for ( int i=0; i < nOutput; i++ ) outputNeurons.push_back(0);
...
********************************************************************/
int* neuralNetwork::feedForwardPattern(std::vector<double> pattern)
{
	feedForward(pattern);
